...
# Model arguments
parser.add_argument('--tessellation-area', default='United Kingdom', help='The area to tessel if a tessellation is not provided')
parser.add_argument('--tessellation-size', type=int, default=25000, help='The tessellation size (meters) if a tessellation is not provided')
parser.add_argument('--dataset', default='uk')
...
parser.add_argument('--oa-geometry', default='geometry', help='Column name of oa\'s geoemtry')
...
def test():
    ...
    with torch.no_grad():
        ...
        test_accuracy = 0.
        n_origins = 0
        for ids, data_temp  in enumerate(test_loader):
            b_data = data_temp[0]
            b_target = data_temp[1]
            test_loss = 0.0
